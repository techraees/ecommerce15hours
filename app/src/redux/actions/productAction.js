  ...
  async (dispatch) => {
    try {
      ...
      if (category == "all") {
        ...
        url = `/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}&ratings[gte]=${ratingsArray[0]}&ratings[lte]=${ratingsArray[1]}`;
      }
