...
import ReviewCard from "./sub/ReviewCard.jsx";
    ...
    <div>
      <div className="w-[100%] grid grid-cols-2 gap-4 justify-center  mb-[20px]">
        ...
        <div className=" py-[50px] px-[5%]">
          ...
          <h2 className="mb-[5px] text-[30px] leading-[3rem] font-[700] ">
          ...
          <div class="flex my-[20px]">
            <button class="bg-gray-100 hover:bg-red-400 text-gray-800 font-bold py-2 px-4 rounded-l">
              -
            </button>
            <input
              class=" bg-transparent border-none w-[50px] text-center text-gray-700  focus:outline-none"
              type="text"
              value="100"
            />
            <button class="bg-gray-100 hover:bg-green-400 text-gray-800 font-bold py-2 px-4 rounded-r">
              +
            </button>
          ...
          <span className="font-[500] text-[1.3rem] ">About this item:</span>
          <p className="mb-[10px] leading-[2rem] font-[700] text-[1rem] leading-[50px] text-[1.2rem] font-[300] pt-[10px]">
      ...
      {product.product.reviewsa && product.product.reviews[0] ? (
